...
<div class="pg-breadcrumb">
   <div class="container-wrapper my-3">
       ...
       <span class="text-primary"><i class="fas fa-caret-right"></i></span>
       <span class="text-primary">Kasangalabi Branch</span>
   </div>
</div>
...
<section class="gulaama">
   <div class="container-wrapper">
        <img src="{{asset('assets/images/main/env.jpg')}}" class="branch-image" alt="kasangalabi branch">
       <p class="mt-3">This is our other branch located at Kasangalabi, Mukono District</p>


       <div class="administration">
           <div class="general-heading">
               <h4>Administration</h4>
               <h2>Kasangalabi School administration</h2>
               <p>
    ...
    <div class="container-wrapper">
        ...
        <div class="facility-container">
            <div class="wrapper">
                ...
                <div class="facility-box">
                    <img src="{{asset('assets/images/icons/icon-accordion-4.webp')}}" alt="icon">
