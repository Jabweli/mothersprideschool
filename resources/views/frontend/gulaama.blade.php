...
<div class="pg-breadcrumb">
   <div class="container-wrapper my-3">
       ...
       <span class="text-primary"><i class="fas fa-caret-right"></i></span>
       <span class="text-primary">Gulaama - Main Campus</span>
   </div>
</div>
...
<section class="gulaama">
   <div class="container-wrapper">
       <img src="{{asset('assets/images/main/about.jpg')}}" width="100%" alt="gulaama image">
       <p class="mt-3">This is our main campus located in Gulaama</p>


       <div class="administration">
           <div class="general-heading">
               <h4>Administration</h4>
               <h2>Gulaama School administration</h2>
               <p>
                   The following is our staff at Mother's Pride Primary & Nursery School - 
                   Gulaama Campus.
               </p>
